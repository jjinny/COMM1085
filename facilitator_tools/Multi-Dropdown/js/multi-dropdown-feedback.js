		...
		function resetAll() {
			...
			$("#mi-table").html('<tr><th id="column-question">Statement</th><th id="column-input">Option</th><th id="column-feedback">Check Feedback</th></tr>');
			initMI(appdata);
		...
		function initMI(data) {
			  ...
			  for(var i=0; i<data.Questions.length; i++) {
				  ...
				  newrow += '</select></div>';
				  newrow += "</td><td class='col-fb'><button class='btn btn-primary btn-check' id='submit-"+i+"' onClick='checkAnswer("+i+")'>Feedback</button></td></tr>";
				  newrow += "<tr><td><div id='feedback-"+i+"'></div>";
				  newrow += "</td></tr>";
