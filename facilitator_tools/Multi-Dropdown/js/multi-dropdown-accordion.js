		...
		function initMI(data) {
			  ...
			  for(var i=0; i<data.Questions.length; i++) {
				  ...
				  newrow += '</select></div>';
				  newrow += "</td><td class='col-fb'><button class='btn-primary btn-check' id='submit-"+i+"' style='font-size: .8rem;padding: .8rem 1.6rem;margin: 6px;border-radius: 2px;border: 0;transition: .2s ease-out; white-space: normal!important;cursor: pointer;' onClick='checkAnswer("+i+")'>Check Answer</button><div id='feedback-"+i+"'></div></td><td><div class='feedbackicon' id='feedbackicon-"+i+"'></div></td>";
				  newrow += "</tr>";
